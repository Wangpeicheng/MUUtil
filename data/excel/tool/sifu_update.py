...
# 命令行参数帮助信息
def usage():
    print("./sifu_update.py [zhaogang|heqiong|wuhang|huayu]")
    sys.exit(1)
...
if __name__ == '__main__':
    ...
    name = sys.argv[1]
    if name != "zhaogang" and name != "heqiong" and name != "wuhang" and name != "huayu" and name != "jiangtao" and name != "xiaolin" and name != "shengmin" and name != "xufeng" :
        usage()
